 ...
 * 
 * @package xajax
 * @version $Id: xajax.inc.php,v 1.6 2007/02/03 00:50:15 chris Exp $
...
class xajax
{
		...
		if ($bFoundFunction) {
			...
			if (!array_key_exists($sFunctionName, $this->aFunctions))
			{
				if ($this->sCatchAllFunction) {
                    ...
                    $objResponse->addAlert("Đã mất session, vui lòng đăng nhập lại!");
	...
	function getJavascriptConfig()
	{
		...
		$html .= "var ranjav = Math.random();var xajaxRequestUri=\"".$this->sRequestURI."?rad=\";\n";//aja="htp../index.php?rand=";
		$html .= "xajaxRequestUri +=ranjav;var xajaxDebug=".($this->bDebug?"true":"false").";\n";
