...
*/
   ...
   */
    ...
    * Assuming that we can have 50 files per directory with good performance,
   ...
   */
    ...
    */
    function adodb_backtrace($printOrArr=true,$levels=9999)
    {
     ...
     // start trung them vao de tinh cho transaction 
    function DBTransactiop(){
        try {
          $dbTranc = new PDO('mysql:host='._DBSERVER_MASTER.';dbname='._DBNAME_MASTER, _DBUSER_MASTER, _DBPASS_MASTER,array(PDO::ATTR_PERSISTENT => true));
         // echo "Connected\n";
        } catch (Exception $e) {
    ...
    // end trung them vao de tinh cho transaction    
