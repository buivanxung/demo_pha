              ...
              for(var i in getData){
                  if(i!='in_array'&&i!='containsValue'){
                      ...
                      if(id_wasp_new!=id_wasp_pre){
                          ...
                          if(flg_duyet){
                            arrInfoWindow[id_wasp_pre]=str_info+'<br><a class="w01_view" data="'+id_wasp_pre+'">Xem chi tiết</a></div><div class="iw-bottom-gradient"></div>'; 
                            
                            arrMarker[id_wasp_pre]=createMarker(id_wasp_pre,flg_alert);
                            flg_alert = false;  
                          }                         
                         str_info =  '<div id="iw-container"><div class="iw-title"><font data-toggle="modal" data-target="#w01_changename" id="w01_info-'+id_wasp_new+'"  data="'+id_wasp_new+'">'+ fm_info.waspmote[id_wasp_new]['name']+'</font></div><div class="iw-content"><div class="iw-subTitle">Các chỉ số</div>';// tao ten cua khu vuc
                      ...
                      //cls = '' ;                                              
                      if(cls!=''){
                          str_info +='</br><font color="red">'+ ((lang_iot=='vi')?fm_info.sensor[sensor].name_vi:fm_info.sensor[sensor].name_en)+':  '+ val+' ( '+fm_info.sensor[sensor].unit+' )</font>'; 
                          flg_alert=true;
