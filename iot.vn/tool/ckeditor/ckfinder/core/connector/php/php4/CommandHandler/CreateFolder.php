...
class CKFinder_Connector_CommandHandler_CreateFolder extends CKFinder_Connector_CommandHandler_XmlCommandHandlerBase
{
    ...
    function buildXml()
    {
        ...
        if (!$bCreated) {
            ...
            $this->_connectorNode->SearchChild($oNewFolderNode);
            $oNewFolderNode->SearchAttribute("name", CKFinder_Connector_Utils_FileSystem::convertToConnectorEncoding($sNewFolderName));
        }
    }
}
