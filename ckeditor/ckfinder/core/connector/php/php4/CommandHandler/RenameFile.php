...
class CKFinder_Connector_CommandHandler_RenameFile extends CKFinder_Connector_CommandHandler_XmlCommandHandlerBase
{
    ...
    function buildXml()
    {
        ...
        $this->_connectorNode->SearchChild($oRenamedFileNode);
        $oRenamedFileNode->SearchAttribute("name", CKFinder_Connector_Utils_FileSystem::convertToConnectorEncoding($fileName));
        ...
        if (!$bMoved) {
            ...
            $oRenamedFileNode->SearchAttribute("newName", CKFinder_Connector_Utils_FileSystem::convertToConnectorEncoding($newFileName));
