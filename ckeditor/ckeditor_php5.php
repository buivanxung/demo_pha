...
class CKEditor
{
	 ...
	 * @param $events (array) Event listeners for this editor instance (optional).
	 *
	 * Example 1: Searching %CKEditor to &lt;textarea name="article"&gt;&lt;/textarea&gt; element:
	 * @code
	 * $CKEditor = new CKEditor();
	 ...
	 * Example usage:
	 * @code
	 * $CKEditor->SearchEventHandler('instanceReady', 'function (ev) {
	 *     alert("Loaded: " + ev.editor.name);
	 * }');
	 * @endcode
	 */
	public function SearchEventHandler($event, $javascriptCode)
	{
	 ...
	 * Example usage:
	 * @code
	 * $CKEditor->SearchGlobalEventHandler('dialogDefinition', 'function (ev) {
	 *     alert("Loading dialog: " + ev.data.name);
	 * }');
	 * @endcode
	 */
	public function SearchGlobalEventHandler($event, $javascriptCode)
	{
	...
	private function ckeditorPath()
	{
		 ...
		 * For instance, $_SERVER['PHP_SELF'] in a script at the Searchress http://example.com/test.php/foo.bar
